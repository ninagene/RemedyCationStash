                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex flex-col gap-y-6">
                        <div class="flex flex-col gap-y-2">
                            <h1 class="text-2xl font-bold text-green-900">Edit Medication Information</h1>
                            <p class="text-sm text-gray-500">Update the details for the selected medication</p>
                        </div>

                        {{-- Edit Medication Form --}}
                        <form wire:submit="updateMedication">
                            ...
                            <div class="flex justify-end mt-6 gap-x-4">
                                <a href="{{ route('medications.index') }}" class="inline-flex items-center px-6 py-3 text-sm font-medium text-white bg-green-600 rounded-lg shadow-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500">
                                    Cancel
                                </a>
